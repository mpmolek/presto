...
import static io.prestosql.plugin.greenplum.TypeUtils.arrayDepth;
import static io.prestosql.plugin.greenplum.TypeUtils.getArrayElementPgTypeName;
import static io.prestosql.plugin.greenplum.TypeUtils.getJdbcObjectArray;
import static io.prestosql.plugin.greenplum.TypeUtils.toPgTimestamp;
        ...
        extends BaseJdbcClient
{
            ...
            TypeManager typeManager)
    {
        ...
        if (greenplumConfig.isIncludeSystemTables()) {
        ...
        this.aggregateFunctionRewriter = new AggregateFunctionRewriter(
                ...
                ImmutableSet.<AggregateFunctionRule>builder()
                        ...
                        .add(new ImplementSum(GreenplumClient::toTypeHandle))
    ...
    public List<JdbcColumnHandle> getColumns(ConnectorSession session, JdbcTableHandle tableHandle)
    {
        try (Connection connection = connectionFactory.openConnection(JdbcIdentity.from(session))) {
            ...
            if (GreenplumSessionProperties.getArrayMapping(session) == GreenplumConfig.ArrayMapping.AS_ARRAY) {
    ...
    public Optional<ColumnMapping> toPrestoType(ConnectorSession session, Connection connection, JdbcTypeHandle typeHandle)
    {
        ...
        if (typeHandle.getJdbcType() == Types.ARRAY) {
            GreenplumConfig.ArrayMapping arrayMapping = GreenplumSessionProperties.getArrayMapping(session);
            if (arrayMapping == GreenplumConfig.ArrayMapping.DISABLED) {
            ...
            if (arrayMapping == GreenplumConfig.ArrayMapping.AS_ARRAY) {
            ...
            if (arrayMapping == GreenplumConfig.ArrayMapping.AS_JSON) {
                return baseElementMapping
    ...
    public WriteMapping toWriteMapping(ConnectorSession session, Type type)
    {
        ...
        if (type instanceof ArrayType && GreenplumSessionProperties.getArrayMapping(session) == GreenplumConfig.ArrayMapping.AS_ARRAY) {
